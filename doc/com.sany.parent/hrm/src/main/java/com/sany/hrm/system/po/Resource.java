...
public class Resource implements java.io.Serializable {
	 ...
	 * 版本号
	 */
	private static final long serialVersionUID = 888130426918892807L;
    ...
    */
	 ...
	 *            修改时间
	 */
	public Resource setModifyTi(Date modifyTi) {
	 ...
	 *            目录_标识
	 */
	public Resource setDirectoryId(String directoryId) {
	 ...
	 *            创建人标识
	 */
	public Resource setCreatePeId(String createPeId) {
	 ...
	 *            分区_标识
	 */
	public Resource setPartitionId(String partitionId) {
	 ...
	 *            创建时间
	 */
	public Resource setCreateTi(Date createTi) {
	 ...
	 *            类型标识
	 */
	public Resource setTypeId(String typeId) {
		this.typeId = typeId;
	 ...
	 *            修改人标识
	 */
	public Resource setModifyPeId(String modifyPeId) {
